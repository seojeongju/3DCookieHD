                    ...
                    <div class="flex-1 p-8 flex flex-col overflow-hidden min-w-0">
                        ...
                        <div id="contentDetails" class="hidden flex-1 overflow-y-auto pr-6 space-y-10 pb-20">
                            ...
                            <div class="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm space-y-6">
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div><label class="text-[10px] font-bold text-gray-400 ml-1 mb-2 block uppercase">지원 유형</label><select id="stdPackageType" class="w-full px-5 py-3 bg-gray-50 border-none rounded-2xl text-sm outline-none cursor-pointer"><option value="">유형 선택</option><option value="type1">국기 (I유형)</option><option value="type2">일반 (II유형)</option><option value="k-digital">K-Digital Training</option><option value="general">일반 실업자/재직자</option></select></div>
                                    <div><label class="text-[10px] font-bold text-gray-400 ml-1 mb-2 block uppercase">자부담금 결제 수단</label><input type="text" id="stdPaymentMethod" class="w-full px-5 py-3 bg-gray-50 border-none rounded-2xl text-sm outline-none" placeholder="예: 신한카드"></div>
