        ...
        <nav class="flex-grow overflow-y-auto py-4">
            ...
            <div class="group">
                <div class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white cursor-pointer transition-colors bg-slate-700">
                    ...
                    <span class="text-sm font-medium flex-grow">NCS훈련성과평가</span>
                    <i class="fas fa-chevron-down text-xs"></i>
                </div>
                <div class="bg-slate-900 py-2">
                    <a href="#" class="sidebar-subitem active">1차 평가(본평가)</a>
                    <a href="#" class="sidebar-subitem">2차 평가(재평가)</a>
                    <a href="#" class="sidebar-subitem">3차 평가(재평가)</a>
                </div>
            </div>
        </nav>
    </aside>
    ...
    <div class="flex-grow flex flex-col h-screen overflow-hidden">
        ...
        <main class="flex-grow overflow-y-auto bg-gray-50 p-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">HOME / MAIN - ([NCS] 평가실행)</p>
            </div>
