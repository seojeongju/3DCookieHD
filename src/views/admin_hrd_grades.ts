...
<head>
    ...
    <title>종합 성적/채점 관리 - 교육행정 시스템</title>
...
<body class="bg-gray-50 font-sans">
            ...
            <div class="bg-white border-b border-gray-200 flex-shrink-0">
                <div class="px-8 py-6">
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">종합 성적/채점 현황</h1>
                            <p class="text-gray-500 mt-1 text-sm">모든 과정의 시험 성적 분포 및 채점 진행 상황을 모니터링합니다.</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <button onclick="loadGradeSummary()" class="p-2.5 bg-white border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50 hover:text-indigo-600 transition-all shadow-sm">
                ...
                <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center group hover:shadow-md transition-all duration-300">
                            ...
                            <div>
                                <div class="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">평균 성적(전체)</div>
                                <div class="text-2xl font-black text-gray-800 tracking-tight text-emerald-600" id="statGlobalAvg">0.0점</div>
                            </div>
                        </div>
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center group hover:shadow-md transition-all duration-300">
                            ...
                            <div>
                                <div class="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">최고 점수</div>
                                <div class="text-2xl font-black text-gray-800 tracking-tight" id="statGlobalMax">0점</div>
                            </div>
                        </div>
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center group hover:shadow-md transition-all duration-300">
                            ...
                            <div>
                                <div class="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">채점 완료율</div>
                                <div class="text-2xl font-black text-gray-800 tracking-tight" id="statCompletionRate">0%</div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-gray-50/50">
                                        ...
                                        <th class="px-6 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center whitespace-nowrap">수강 인원</th>
                                        <th class="px-6 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center whitespace-nowrap">산출 인원</th>
                                        <th class="px-6 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center whitespace-nowrap">평균 점수</th>
                                        <th class="px-6 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center whitespace-nowrap">최고 점수</th>
                                        <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-right whitespace-nowrap">상세 성적표</th>
                                    </tr>
                                </thead>
    ...
    <script>
        ...
        async function loadGradeSummary() {
            try {
                const res = await fetch('/api/hrd/grades/summary', {
        ...
        function renderSummaryTable(data) {
            ...
            tbody.innerHTML = data.map(c => \`
                <tr class="hover:bg-indigo-50/30 transition-colors group border-b border-gray-50 last:border-0 shadow-[inset_0_1px_0_0_rgba(255,255,255,1)]">
                    ...
                    <td class="px-6 py-5 text-center text-sm font-black text-slate-700 whitespace-nowrap align-top">\${c.student_count ?? 0}명</td>
                    <td class="px-6 py-5 text-center text-sm font-black text-indigo-500 whitespace-nowrap align-top">\${c.tested_count ?? 0}명</td>
                    <td class="px-6 py-5 text-center whitespace-nowrap align-top">
