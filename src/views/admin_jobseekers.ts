    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">인재풀 관리</h1>
                    <p class="text-gray-600 mt-1">등록된 구직자 정보를 조회하고 관리합니다.</p>
                </div>
                <button onclick="openModal('createJobseekerModal')" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition flex items-center">
