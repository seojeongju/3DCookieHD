...
export const adminHrdNcsResultHtml = `
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>HRD 행정관리 시스템 - NCS 평가결과</title>
        ...
        <nav class="flex-grow overflow-y-auto py-4">
            ...
            <div class="group">
                <div class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white cursor-pointer transition-colors">
                    <i class="fas fa-edit w-6 text-center mr-3"></i>
                    <span class="text-sm font-medium flex-grow">사전평가</span>
            ...
            <div class="group">
                <div class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white cursor-pointer transition-colors">
                    <i class="fas fa-check-square w-6 text-center mr-3"></i>
                    <span class="text-sm font-medium flex-grow">종료된 평가 채점</span>
                    <i class="fas fa-chevron-right text-xs opacity-50 group-hover:opacity-100"></i>
                </div>
            </div>
            ...
            <div class="group">
                <div class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white cursor-pointer transition-colors">
                    ...
                    <span class="text-sm font-medium flex-grow">재평가 결과 분석</span>
                    <i class="fas fa-chevron-right text-xs opacity-50 group-hover:opacity-100"></i>
                </div>
            </div>
            ...
            <div class="group">
                <div class="flex items-center px-6 py-3 text-gray-300 hover:bg-slate-700 hover:text-white cursor-pointer transition-colors">
                    ...
                    <span class="text-sm font-medium flex-grow">결과 통계/회의록</span>
                    <i class="fas fa-chevron-right text-xs opacity-50 group-hover:opacity-100"></i>
                </div>
            </div>
        </nav>
    ...
    <div class="flex-grow flex flex-col h-screen overflow-hidden">
        ...
        <main class="flex-grow overflow-y-auto bg-gray-50 p-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">HOME / MAIN - ([NCS] 평가결과)</p>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm mb-6">
                <div class="p-4 border-b border-gray-200">
                    <h2 class="text-lg font-light text-gray-700">[NCS] 평가 결과 목록</h2>
                </div>
