...
<link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
    <style>
        .consultation-card:hover .view-mode { display: none; }
        .consultation-card:hover .edit-actions { display: flex; }
        /* 스크롤바 커스텀 */
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">수강생 정보와 상담 이력을 통합 관리합니다.</p>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 mb-6 flex flex-wrap gap-4 items-center justify-between">
                <div class="flex gap-4 items-center flex-1">
                    <div class="relative flex-1 max-w-md">
                        <input type="text" id="studentSearch" onkeyup="filterStudents()" placeholder="이름, 이메일, 전화번호 검색..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">수강생</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">연락처</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">수강이력</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">최근상담</th>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">일시</th>
                        </tr>
                    </thead>
    ...
    <script>
        ...
        async function viewStudentDetail(studentId) {
            ...
            try {
                ...
                // 상담 이력 (다이어리 스타일)
                const consultationsHtml = student.consultations.length > 0 ? 
                    renderConsultationDiary(student.consultations) : 
                    '<div class="text-sm text-gray-500 text-center py-8"><i class="fas fa-book-open mr-2"></i>상담 이력이 없습니다. 첫 상담을 기록해보세요!</div>';
