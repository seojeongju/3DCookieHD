                                                                                                                                            ...
                                                                                                                                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                                                                                                                                ...
                                                                                                                                                <div class="bg-gradient-to-r from-primary-600 to-purple-700 rounded-xl shadow-2xl p-12 text-center text-white">
                                                                                                                                                    ...
                                                                                                                                                    <div class="flex flex-wrap justify-center gap-4">
                                                                                                                                                        ...
                                                                                                                                                        <a href="tel:02-3144-3137" class="inline-block bg-yellow-400 text-gray-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-300 transition shadow-lg">
