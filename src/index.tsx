...
import studentClassroom from './api/student_classroom';
...
app.route('/api/student/classroom', studentClassroom);
...
app.get('/admin/students/:id/journey', (c) => c.html(adminHrdStudentJourneyHtml(c.req.param('id'))));
...
app.get('/teacher/courses/:id/lms/counseling', (c) => c.html(adminHrdCounselingHtml(c.req.param('id'), teacherSidebar('courses', 'counseling'))));
...
app.get('/teacher/courses/:id/lms/employment', (c) => c.html(adminLmsEmploymentHtml(teacherSidebar('courses', 'employment'))));
app.get('/teacher/courses/:id/lms/training-logs', (c) => c.html(adminLmsTrainingLogsHtml(teacherSidebar('courses', 'training-logs'))));
app.get('/teacher/courses/:id/lms/cbt', (c) => c.html(adminLmsCbtHtml(teacherSidebar('courses', 'exams'))));
app.get('/teacher/courses/:id/lms/grades', (c) => c.html(adminLmsGradesHtml(teacherSidebar('courses', 'grades'))));
...
app.get('/faq', async (c) => {
    try {
        ...
        const aeoDefaults: PublicFaq[] = [
            ...
            {
                title: '내일배움카드는 어떻게 발급받나요?',
                answer: '고용24(워크넷)에서 회원가입 후 상담·심사를 거쳐 국민내일배움카드를 발급받습니다. 자격·한도는 연도별 고시에 따르며, 와우쓰리디 내일배움카드 안내 페이지에서 절차 요약을 볼 수 있습니다.',
            },
            {
                title: '3D프린터 국가자격증이 있나요?',
                answer: '있습니다. 국가기술자격 공식 명칭은 3D프린터운용기능사입니다. 와우쓰리디에서 실기 대비 과정(주말반·평일저녁반)을 운영하며, 자세한 안내는 기능사 자격증 가이드를 보세요.',
            },
            {
                title: '3D프린팅 기능사란 무엇인가요?',
                answer: '일반적으로 말하는 3D프린팅 기능사는 국가기술자격 3D프린터운용기능사를 가리킵니다. 모델링·출력·후가공 실무 능력을 검증하는 자격이며, 와우쓰리디에서 대비 교육을 제공합니다.',
            },
            {
            ...
            {
                title: '3D프린터 무료교육이 있나요?',
                answer: '완전 무료 과정은 회차·자격에 따라 다릅니다. 국민내일배움카드(국비지원)를 이용하면 훈련비 부담을 크게 줄일 수 있습니다. 지원 가능 여부는 상담 시 해당 회차 기준으로 안내합니다.',
            },
            {
                                                                                                                                                        ...
                                                                                                                                                        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                                                                                                                                            ...
                                                                                                                                                            <div class="grid md:grid-cols-2 gap-6">
                                                                                                                                                                ...
                                                                                                                                                                <div class="bg-green-50 border-l-4 border-green-600 p-6 rounded-lg">
                                                                                                                                                                    ...
                                                                                                                                                                    <ul class="space-y-2 text-gray-700">
                                                                                                                                                                        <li><i class="fas fa-check text-green-600 mr-2"></i>이메일: wow3d16@naver.com</li>
