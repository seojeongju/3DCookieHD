                                                                                                                                                        ...
                                                                                                                                                        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                                                                                                                                                            ...
                                                                                                                                                            <div class="grid md:grid-cols-2 gap-6">
                                                                                                                                                                ...
                                                                                                                                                                <div class="bg-green-50 border-l-4 border-green-600 p-6 rounded-lg">
                                                                                                                                                                    ...
                                                                                                                                                                    <ul class="space-y-2 text-gray-700">
                                                                                                                                                                        <li><i class="fas fa-check text-green-600 mr-2"></i>이메일: wow3d@wow3d.co.kr</li>
                                                                                                                                                                        <li><i class="fas fa-check text-green-600 mr-2"></i>홍대: 02-332-9010</li>
                                                                                                                                                                        <li><i class="fas fa-check text-green-600 mr-2"></i>구미: 02-6014-9010</li>
