...
// ============================================================
// /api/cbt/exams  -  exams 테이블을 course_id 기준으로 관리
// ============================================================

// GET /api/cbt/exams?course_id=xxx  - 과정별 시험 목록 조회
...
// GET /api/cbt/questions?course_id=xxx  - 과정별 문제 목록 조회
...
cbt.post('/questions', authMiddleware, async (c) => {
    try {
        ...
        // exam_id 결정: 없으면 course_id로 가장 최근 시험에 연결
